...
*/
public interface IJsonThermalCon
{
    Root ThermalConFromJson(string SeriallizedInputJson, TypeOfData typeOfData);
}

public class JsonThermalCon : IJsonThermalCon
{
    public Root ThermalConFromJson(string SeriallizedInputJson, TypeOfData typeOfData)
    {
